...
tardis.draw_error_sprite = function(entity, sprite, time_to_live)
...
---@param factor number?
---@return Position
tardis.randomize_position = function(position, factor)
...
---@param color Color?
tardis.cancel_creation = function(entity, player_index, message, color)
    local inserted = 0
...
tardis.find_grandparent = function(element, name)
    while element do
...
tardis.format_energy = function(energy, watts_or_joules)
...
---@return number
tardis.distance_squared = function(first, second)
...
---@param args table
tardis.create_flying_text = function(args)
